...
🌐 **[Live Demo: osintview.app](https://osintview.app)** | 💻 **[Tech Variant: tech.osintview.app](https://tech.osintview.app)**
...
![OSINTview Dashboard](images/new-world-monitor.png)

## Platform Variants

OSINTview runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 OSINTview** | [osintview.app](https://osintview.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.osintview.app](https://tech.osintview.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.osintview.app](https://tech.osintview.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that OSINTview users may depend on.
...
// App.ts
const header = `OSINTview v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between OSINTview and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/osintview.git
   cd osintview
   ```
