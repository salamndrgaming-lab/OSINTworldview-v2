...
description: "OSINTview platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
OSINTview runs five specialized variants from a single codebase, each optimized for different monitoring needs.
...
| **😊 Happy Monitor** | [happy.osintview.app](https://happy.osintview.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.osintview.app](https://finance.osintview.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.osintview.app](https://commodity.osintview.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
...
The finance variant ([finance.osintview.app](https://finance.osintview.app)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.osintview.app](https://commodity.osintview.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.osintview.app](https://happy.osintview.app)) curates positive news, human progress data, and uplifting stories.
