...
const PUBLIC_API_PATHS = new Set(['/api/version', '/api/health', '/api/telegram-webhook']);
...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.osintview.app': 'tech',
  'finance.osintview.app': 'finance',
  'happy.osintview.app': 'happy',
};
