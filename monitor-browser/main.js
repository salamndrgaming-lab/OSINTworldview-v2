...
app.whenReady().then(() => {
  ...
  //    file:// or localhost — YouTube rejects embeds without a recognized
  //    web origin. We inject Referer for embed/video requests only.
