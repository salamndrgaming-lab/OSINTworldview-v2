...
import type {
  ...
  ArxivPaper,
} from '../../../../src/generated/server/osintview/research/v1/service_server';
...
const xmlParser = new XMLParser({
  ...
  isArray: (_name: string, jpath: string | object, _isLeafNode: boolean, _isAttribute: boolean) =>
    /\.(entry|author|category|link)$/.test(String(jpath)),
});
