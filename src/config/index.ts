...
// VITE_VARIANT=tech → tech.osintview.app (tech-focused)
// VITE_VARIANT=full → osintview.app (geopolitical)
// VITE_VARIANT=finance → finance.osintview.app (markets/trading)
