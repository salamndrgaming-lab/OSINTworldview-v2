...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'OSINTview - Real-Time Global Intelligence Dashboard',
  ...
  tech: {
    title: 'OSINTview Tech - Real-Time AI & Tech Industry Dashboard',
    ...
    url: 'https://tech.osintview.app/',
    siteName: 'OSINTview Tech',
    shortName: 'OSINTview Tech',
  ...
  happy: {
    title: 'OSINTview Good News - Positive Stories & Global Progress',
    ...
    url: 'https://happy.osintview.app/',
    siteName: 'OSINTview Good News',
    shortName: 'OSINTview Happy',
  ...
  finance: {
    title: 'OSINTview Finance - Real-Time Markets & Trading Dashboard',
    ...
    url: 'https://finance.osintview.app/',
    siteName: 'OSINTview Finance',
    shortName: 'OSINTview Finance',
  ...
  commodity: {
    title: 'OSINTview Commodity - Real-Time Commodity Markets & Supply Chain Dashboard',
    ...
    url: 'https://commodity.osintview.app/',
    siteName: 'OSINTview Commodity',
    shortName: 'OSINTview Commodity',
