...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/osintview/conflict/v1/handler.ts', 'server/osintview/infrastructure/v1/handler.ts', 'server/osintview/cyber/v1/handler.ts', 'server/osintview/maritime/v1/handler.ts', 'server/osintview/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/osintview/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/osintview/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/osintview/military/v1/handler.ts'],
    locality: 'api-key',
