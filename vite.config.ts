  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "OSINTview"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "OSINTview"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/osintview\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      naturalServerMod, naturalHandlerMod,
        ...
        import('./src/generated/server/osintview/seismology/v1/service_server'),
        import('./server/osintview/seismology/v1/handler'),
        import('./src/generated/server/osintview/wildfire/v1/service_server'),
        import('./server/osintview/wildfire/v1/handler'),
        import('./src/generated/server/osintview/climate/v1/service_server'),
        import('./server/osintview/climate/v1/handler'),
        import('./src/generated/server/osintview/prediction/v1/service_server'),
        import('./server/osintview/prediction/v1/handler'),
        import('./src/generated/server/osintview/displacement/v1/service_server'),
        import('./server/osintview/displacement/v1/handler'),
        import('./src/generated/server/osintview/aviation/v1/service_server'),
        import('./server/osintview/aviation/v1/handler'),
        import('./src/generated/server/osintview/research/v1/service_server'),
        import('./server/osintview/research/v1/handler'),
        import('./src/generated/server/osintview/unrest/v1/service_server'),
        import('./server/osintview/unrest/v1/handler'),
        import('./src/generated/server/osintview/conflict/v1/service_server'),
        import('./server/osintview/conflict/v1/handler'),
        import('./src/generated/server/osintview/maritime/v1/service_server'),
        import('./server/osintview/maritime/v1/handler'),
        import('./src/generated/server/osintview/cyber/v1/service_server'),
        import('./server/osintview/cyber/v1/handler'),
        import('./src/generated/server/osintview/economic/v1/service_server'),
        import('./server/osintview/economic/v1/handler'),
        import('./src/generated/server/osintview/infrastructure/v1/service_server'),
        import('./server/osintview/infrastructure/v1/handler'),
        import('./src/generated/server/osintview/market/v1/service_server'),
        import('./server/osintview/market/v1/handler'),
        import('./src/generated/server/osintview/news/v1/service_server'),
        import('./server/osintview/news/v1/handler'),
        import('./src/generated/server/osintview/intelligence/v1/service_server'),
        import('./server/osintview/intelligence/v1/handler'),
        import('./src/generated/server/osintview/military/v1/service_server'),
        import('./server/osintview/military/v1/handler'),
        import('./src/generated/server/osintview/positive_events/v1/service_server'),
        import('./server/osintview/positive-events/v1/handler'),
        import('./src/generated/server/osintview/giving/v1/service_server'),
        import('./server/osintview/giving/v1/handler'),
        import('./src/generated/server/osintview/trade/v1/service_server'),
        import('./server/osintview/trade/v1/handler'),
        import('./src/generated/server/osintview/supply_chain/v1/service_server'),
        import('./server/osintview/supply-chain/v1/handler'),
        import('./src/generated/server/osintview/natural/v1/service_server'),
        import('./server/osintview/natural/v1/handler'),
      ]);
